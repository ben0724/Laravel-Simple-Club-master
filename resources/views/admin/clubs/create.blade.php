...
<div class="container-fluid">
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-12">
                <form class="form-horizontal" action="{{ url('/admin/clubs') }}" method="post">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control @error('shortname') is-invalid @enderror" id="shortname" type="text" name="shortname" value="{{ old('shortname') }}" placeholder="Enter Short Name.." >
                          @error('shortname')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Enter Email..">
                          @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control @error('siteurl') is-invalid @enderror" id="siteurl" type="url" name="siteurl" value="{{ old('siteurl') }}" placeholder="Enter Site Url..">
                          @error('siteurl')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
